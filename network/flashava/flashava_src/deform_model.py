...
from flashava_flame import FLAME_mica, parse_args
from flashava_utils.general_utils import Pytorch3dRasterizer, Embedder, load_binary_pickle, a_in_b_torch, face_vertices_gen
...
class Deform_Model(nn.Module):
    def __init__(self, device):
        ...
        _, faces, aux = load_obj('flashava_flame/FlameMesh.obj', load_textures=False)
        ...
        # flame mask
        flame_mask_path = "flashava_flame/FLAME_masks/FLAME_masks.pkl"   
